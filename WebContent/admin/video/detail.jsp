            ...
            <h3>동영상 게시판</h3>
                ...
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane fade in active" id="small">
                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${videoVO.vDate}" />
                        </div>
                     </div>
               ...
               <div class="form-group col-md-12" style="width:100%; height:56.25%">
                  <iframe id="vid_prv" width=100% height="56.25%"
                     src="https://www.youtube.com/embed/${videoVO.vUrl}"
                     frameborder="0" gesture="media" allow="encrypted-media"
                     allowfullscreen></iframe>
               </div>
               
               <div class="form-group col-md-12">${videoVO.vContent}</div>
               <!-- <div class="col-md-12">
                  <button style="float: right;" type="button" class="btn btn-border btn-theme-colored" id="cancleBtn">목록</button>
					...
					onclick="location.href='/adminVideo?command=adminVideoModifyForm&vNum=${videoVO.vNum}'">
							<i class="fas fa-clipboard-list">수정</i>
						</button>	  
                        
                        <button id='deleteBtn' type="button" class="btn btn-default" 
					onclick="location.href='/adminVideo?command=adminVideoDelete&vNum=${videoVO.vNum}'">
							<i class="fas fa-trash-alt">삭제</i>
						</button>
                       
					<button id='listBtn' type="button" class="btn btn-default" 
					onclick="location.href='/adminVideo?command=adminVideoList'">
