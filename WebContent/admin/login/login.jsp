...
<section>
	<div class="container">
		<div class="row">
		          ...
		          <div class="container">
		            <div class="row">
		              <div class="col-md-6 col-md-push-1">
		                ...
		                <hr>
			 <form class="form" name="fm" method=post action = "/adminLogin?command=login">
		   ...
		   <!--              
		              <form name="login-form" onsubmit="return validateEmptyVal()"
		                role="form" class="clearfix" method="post" action="loginPost">
		                  <div class="row">
		                  ...
		                  <div class="clear text-center pt-10">
		                    <button type="submit" class="btn btn-dark btn-lg btn-block no-border mt-15 mb-15" data-bg-color="#3b5998">
		                    	학원생 계정으로 로그인
		                    </button>
